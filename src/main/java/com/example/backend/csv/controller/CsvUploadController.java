...
public class CsvUploadController {
   ...
   * @return 処理結果のレスポンス
   */
  @Operation(summary = "在庫CSVファイルアップロード", description = "在庫情報が記載されたCSVファイルをアップロードし、stock_masterテーブルに登録します")
  @ApiResponses(value = {
   ...
   */
  @Operation(summary = "CSVテンプレートダウンロード", description = "在庫登録用CSVテンプレートファイルの情報を返します")
  ...
  public ResponseEntity<Map<String, Object>> getCsvTemplateInfo() {
    ...
    example.put("manufacturer", "○○電機");
    example.put("suplier", "○○商事");
    example.put("current_stock", "100");
    example.put("location", "倉庫A");
    example.put("remarks", "特記事項なし");
